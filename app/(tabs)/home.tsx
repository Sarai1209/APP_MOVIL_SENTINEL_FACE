        ...
        <View style={styles.statusCard}>
          ...
          <View style={styles.statsRow}>
            <View style={styles.statItem}>
              <Text style={[styles.statValue, { color: C.pinkNeon }]}>
                {logs.length}
              </Text>
              <Text style={styles.statLabel}>Registros</Text>
            </View>
            <View style={styles.statItem}>
              <Text style={[styles.statValue, { color: C.greenNeon }]}>
                {granted}
              </Text>
              <Text style={styles.statLabel}>Accesos</Text>
            </View>
            <View style={styles.statItem}>
              <Text style={[styles.statValue, { color: C.redAlert }]}>
                {denied}
              </Text>

...
import { Bell, Clock, Home, ScanFace, User } from 'lucide-react-native';
...
export default function TabLayout() {
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen name="history" options={{ title: 'Historial', tabBarIcon: ({ color }) => <Clock   size={24} color={color} /> }} />

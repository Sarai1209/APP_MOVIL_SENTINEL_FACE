...
import { BarChart3, Bell, ImageIcon, Settings, Shield, Users } from 'lucide-react-native';
...
export default function AdminLayout() {
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen name="gallery"   options={{ title: 'Galería',   tabBarIcon: ({ color }) => <ImageIcon size={24} color={color} /> }} />
